...
8. *(optional)* If you want to verify your protected song, run `./unprotectSong --outfile unprotected.wav --infile global_provisioning/audio/demo.drm --aes global_provisioning/aes_key --mdKey ./global_provisioning/md_key --chunkKey ./global_provisioning/chunk_key`. Note that cryptographic keys should be located in `global_provisioning/`.
